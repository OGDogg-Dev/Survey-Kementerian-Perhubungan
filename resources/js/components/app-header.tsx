        ...
        <>
            <div className="border-b border-sidebar-border/80" data-app-topbar>
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <Link href={routeOr('dashboard', undefined, '/dashboard')} prefetch className="flex items-center space-x-2">
                        <AppLogo />
                    </Link>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger>
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="group ml-1 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-transparent p-0 text-sm font-medium text-foreground ring-offset-background transition-colors hover:bg-glacier/10 hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                                                >
